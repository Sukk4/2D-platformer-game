...
*/
  ...
  // a.y>b.y+64-15 && a.y<b.y+b.s

  /*if player.x < block.x+block.width
    player.x+width >block.x
    player.y<block.y+block.height
    player.y>block.y+block.height-10
bottom col
    a.x<b.x+b.s && a.x+a.width>b.x && a.y<b.y+b.s && a.y>b.y+b.s-10
*/

    // right col a.y<b.y+b.s && a.y+a.width>b.y && a.x<b.x+b.s && a.x>b.x+b.s-10
    //left col a.y<b.y+b.s && a.y+a.width>b.y && a.x+a.width>b.x && a.x<b.x+10

    //player.x+width<block.x && player

/*var bottomCol = function(a, b){
   if  ((b.y <= a.y+a.height)&&(b.y + b.height >= a.y) && (b.x<=a.x+a.width) && (b.x+b.width>=a.x))
      {return true;}
    else {return false;}  
  };
*/
...
/*var leftCollision = function (a, b){
	if (a.x+a.width>=b.x && a.y>=a.y){return}
}*/
...
var rectDotCol3 = function(a,b){ // b= rect, a = dot  TÄSSÄ FUNCTIOSSA ON JOTAIN VIALLA! erroria heittää vaikka sama ku rectdotcol4
  //console.log(a.x);
  if (b.x<=a.x && b.x+64>=a.x && b.y<=a.y && b.y+64>=a.y){ 
    return true;}
    else {
